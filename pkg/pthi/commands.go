...
func (pthi PTHICommand) enumerateHashHandles() (AMTHashHandles, error) {
...
func (pthi PTHICommand) GetCertificateHashes(hashHandles AMTHashHandles) (hashEntryList []CertHashEntry, err error) {
